...
const EQUIPE = [
  { nome: 'Amanda Dahm', cargo: 'Veterinária e Fundadora', especialidade: 'Medicina Veterinária', icon: 'medical' },
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          Dra. Amanda Dahm, veterinária com mais de 15 anos de experiência, nosso hotel começou
